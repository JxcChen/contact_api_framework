...
public class Constant {
     ...
     * 合同管理系统api
     */
    public static final String CMS_API_DIR = "src/test/resources/api/cms";
    /**
     * 基础数据平台api
     */
     ...
     * 客户服务接口测试集合
     */
    public static final String CUSTOMER_SERVICE_COLLECTIONS_DIR = "src/test/resources/testcase/cms/collections/customer-service.yaml";
